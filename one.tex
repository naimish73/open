...
% Header and footer
\fancyhf{}
\fancyhead[L]{\includegraphics[height=0.8cm]{/app/dist/assets/uptrend_logo.png}}
...
\begin{titlepage}
    ...
    % Logo
    \includegraphics[width=0.3\textwidth]{/app/dist/assets/uptrend_logo.png}\\[1cm]
    ...
    % Mascot
    \includegraphics[width=0.2\textwidth]{/app/dist/assets/uptrend_mascot.png}\\[1cm]
    
    {\large\textcolor{uptrendgray}{Report Generated: 8/29/2025}}\\[0.3cm]
    {\large\textcolor{uptrendgray}{Correlation ID: f17d11fa-d3b5-4a2b-8fba-34a74927ed6c}}
...
\hrule
\vspace{0.3cm}
\includegraphics[height=1cm]{/app/dist/assets/uptrend_mascot.png}\\[0.2cm]
\textcolor{uptrendblue}{\textbf{Uptrend Business Organization}}\\
